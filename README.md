...
|-----------|------|------------|
| **Windows 10+** | [**AGI-Setup.exe**](https://github.com/Belvist/AGI-CODE/releases/latest/download/AGI-Setup-0.2.6.exe) | Только установщик — **не** скачивайте отдельный `AGI.exe` |
| **macOS 11+** (Apple Silicon) | **AGI-0.2.6-arm64.dmg** | См. [Releases](https://github.com/Belvist/AGI-CODE/releases/latest) — загрузка после сборки на Mac |
| **macOS 11+** (Intel) | `AGI-0.2.6-x64.dmg` | На странице [Releases](https://github.com/Belvist/AGI-CODE/releases/latest), если опубликован |
...
## Что нового в v0.2.6 (сводка 0.2.1–0.2.6)
